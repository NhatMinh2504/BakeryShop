...
namespace KingBakery.Controllers
{
    ...
    {
        private readonly KingBakeryManagementContext _context;
        private readonly ILogger<HomeController> _logger;

        public HomeController(ILogger<HomeController> logger, KingBakeryManagementContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public async Task<IActionResult> Vouchers()
        {
            ...
            return View(await _context.Vouchers.Include(v => v.UserId)
        ...
        {
            var bakeries = _context.Bakeries
            ...
            var bakeryQuery = _context.Bakeries.Include(b => b.Category)
                                             .Include(b => b.BakeryOptions);
            ...
            //bestseller
            var bestSellingProduct = _context.OrderItems
                        .Include(oi => oi.Order)
                        .Where(oi => oi.Order != null && oi.Order.Status == "Đã giao hàng")
            ...
            //newest
            var newestProduct = _context.Bakeries.OrderByDescending(b => b.Id).FirstOrDefault();
